          ...
          <div className="Row">
            <div className="RowItem">
              <input
                ...
                type="text"
                data-type="number"
                value={this.cleanNumber(this.props.config.settings.server.port)}
                onChange={e => {
          ...
          <div className="Row">
            <div className="RowItem">
              <input
                ...
                type="text"
                data-type="number"
                value={this.cleanNumber(this.props.config.settings.server.network_id)}
            ...
            <div className="Row">
              <div className="RowItem">
                <input
                  ...
                  type="text"
                  data-type="number"
                  value={this.cleanNumber(this.props.config.settings.server.blockTime)}
                  onChange={this.validateChange}
                />
