...
class GanacheScreen extends Component {
  constructor (props) {
    ...
    this.state = {
      logDirectory: props.settings.workspace.logDirectory
    }
  }
            ...
            <div className="RowItem">
              <div className="Switch">
                <input
                  ...
                  checked={this.props.settings.workspace.server.verbose}
                />
            ...
            <div className="RowItem">
              <div className="Switch">
                <input
                  ...
                  onChange={this.props.handleInputChange}
                  checked={this.props.settings.global.googleAnalyticsTracking == true}
                />
